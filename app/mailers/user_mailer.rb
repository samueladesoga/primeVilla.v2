class UserMailer < ApplicationMailer
  def welcome_email
    ...
    mail(to: @user.email_address, bcc: "samueladesoga@gmail.com", subject: "Welcome to the SSHall hostel management system")
  end

  def tenancy_created
    @tenancy = params[:tenancy]
    mail(to: @tenancy.user.email_address, bcc: "samueladesoga@gmail.com", subject: "Tenancy Created on SS Hall Hostel Management System")
  end
